...
{
    /// <summary>
    /// Partial class containing conversion routines specific to custom APIs.
    /// </summary>
    public partial class RequestConverter
    {
        /// <summary>
        /// Converts a custom API invocation to an <see cref="OrganizationRequest"/>.
        /// </summary>
        ...
        private void ConvertToCustomApi(IEdmOperation operation, RequestConversionResult conversionResult, EntityReference target)
        {
            if (operation == null)
            {
